...
if __name__ == '__main__':
    ...
    # args.submission_file_dir = os.environ["SUBMISSION_DIR"]

    args.set_type = "validation"
    args.model_name = "deepseek-chat"
    args.mode = "sole-planning"
    args.strategy = "cot"
    args.output_dir = "evaluation/output_cot_deepseekchat_soleplanning/"
    args.submission_dir = "evaluation/submission"
