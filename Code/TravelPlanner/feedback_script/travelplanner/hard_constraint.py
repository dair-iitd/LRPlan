...
def evaluation(query_data, tested_data):
    ...
    if get_total_cost(query_data, tested_data) <= query_data['budget']:
        return_info['valid_cost'] = (True, None)
    else:
        return_info['valid_cost'] = (False, f"The total cost should be less than {query_data['budget']}.")
...
def boolean_evaluation(query_data, tested_data):
    ...
    if get_total_cost(query_data, tested_data) <= query_data['budget']:
        ...
        return_info['valid_cost'] = (False, f"The amount spent on restaurants, accommodation and transportation for {query_data['people_number']} number of people exceeded the budget. The total cost should be less than {query_data['budget']}.")
